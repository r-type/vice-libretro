...
#define FFMPEG_CONFIGURATION "--enable-libmp3lame --enable-libx264 --enable-static --disable-programs --enable-gpl --enable-w32threads --extra-cflags=-Iinclude --extra-ldflags='-Llib -Llib64'"
