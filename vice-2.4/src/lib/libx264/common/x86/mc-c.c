...
#ifdef IDE_COMPILE
void x264_mbtree_propagate_list_internal_ssse3( int16_t (*mvs)[2], int16_t *propagate_amount, uint16_t *lowres_costs, int16_t *output, int bipred_weight, int mb_y, int len );static void x264_mbtree_propagate_list_ssse3( x264_t *h, uint16_t *ref_costs, int16_t (*mvs)[2], int16_t *propagate_amount, uint16_t *lowres_costs, int bipred_weight, int mb_y, int len, int list ){ int16_t *current = h->scratch_buffer2; x264_mbtree_propagate_list_internal_ssse3( mvs, propagate_amount, lowres_costs, current, bipred_weight, mb_y, len ); { unsigned stride = h->mb.i_mb_stride; { unsigned width = h->mb.i_mb_width; { unsigned height = h->mb.i_mb_height; { unsigned i = 0; for(  ; i < len; current += 32 ) { int end = ( (i+8)<(len) ? (i+8) : (len) ); for( ; i < end; i++, current += 2 ) { if( !(lowres_costs[i] & (1 << (list+14))) ) continue; { unsigned mbx = current[0]; { unsigned mby = current[1]; { unsigned idx0 = mbx + mby * stride; { unsigned idx2 = idx0 + stride; if( !(((x264_union32_t*)(mvs[i]))->i) ) { (ref_costs[idx0]) = ( ((ref_costs[idx0])+(current[16]))<((1<<15)-1) ? ((ref_costs[idx0])+(current[16])) : ((1<<15)-1) ); continue; } if( mbx < width-1 && mby < height-1 ) { do{ ((ref_costs+idx0)[0]) = ( (((ref_costs+idx0)[0])+((current+16)[0]))<((1<<15)-1) ? (((ref_costs+idx0)[0])+((current+16)[0])) : ((1<<15)-1) ); ((ref_costs+idx0)[1]) = ( (((ref_costs+idx0)[1])+((current+16)[1]))<((1<<15)-1) ? (((ref_costs+idx0)[1])+((current+16)[1])) : ((1<<15)-1) );} while(0); do{ ((ref_costs+idx2)[0]) = ( (((ref_costs+idx2)[0])+((current+32)[0]))<((1<<15)-1) ? (((ref_costs+idx2)[0])+((current+32)[0])) : ((1<<15)-1) ); ((ref_costs+idx2)[1]) = ( (((ref_costs+idx2)[1])+((current+32)[1]))<((1<<15)-1) ? (((ref_costs+idx2)[1])+((current+32)[1])) : ((1<<15)-1) );} while(0); } else { if( mby < height ) { if( mbx < width ) (ref_costs[idx0+0]) = ( ((ref_costs[idx0+0])+(current[16]))<((1<<15)-1) ? ((ref_costs[idx0+0])+(current[16])) : ((1<<15)-1) ); if( mbx+1 < width ) (ref_costs[idx0+1]) = ( ((ref_costs[idx0+1])+(current[17]))<((1<<15)-1) ? ((ref_costs[idx0+1])+(current[17])) : ((1<<15)-1) ); } if( mby+1 < height ) { if( mbx < width ) (ref_costs[idx2+0]) = ( ((ref_costs[idx2+0])+(current[32]))<((1<<15)-1) ? ((ref_costs[idx2+0])+(current[32])) : ((1<<15)-1) ); if( mbx+1 < width ) (ref_costs[idx2+1]) = ( ((ref_costs[idx2+1])+(current[33]))<((1<<15)-1) ? ((ref_costs[idx2+1])+(current[33])) : ((1<<15)-1) ); } } } } } } }} }} } } }
void x264_mbtree_propagate_list_internal_avx( int16_t (*mvs)[2], int16_t *propagate_amount, uint16_t *lowres_costs, int16_t *output, int bipred_weight, int mb_y, int len );static void x264_mbtree_propagate_list_avx( x264_t *h, uint16_t *ref_costs, int16_t (*mvs)[2], int16_t *propagate_amount, uint16_t *lowres_costs, int bipred_weight, int mb_y, int len, int list ){ int16_t *current = h->scratch_buffer2; x264_mbtree_propagate_list_internal_avx( mvs, propagate_amount, lowres_costs, current, bipred_weight, mb_y, len ); { unsigned stride = h->mb.i_mb_stride; { unsigned width = h->mb.i_mb_width; { unsigned height = h->mb.i_mb_height; { unsigned i = 0; for(  ; i < len; current += 32 ) { int end = ( (i+8)<(len) ? (i+8) : (len) ); for( ; i < end; i++, current += 2 ) { if( !(lowres_costs[i] & (1 << (list+14))) ) continue; { unsigned mbx = current[0]; { unsigned mby = current[1]; { unsigned idx0 = mbx + mby * stride; { unsigned idx2 = idx0 + stride; if( !(((x264_union32_t*)(mvs[i]))->i) ) { (ref_costs[idx0]) = ( ((ref_costs[idx0])+(current[16]))<((1<<15)-1) ? ((ref_costs[idx0])+(current[16])) : ((1<<15)-1) ); continue; } if( mbx < width-1 && mby < height-1 ) { do{ ((ref_costs+idx0)[0]) = ( (((ref_costs+idx0)[0])+((current+16)[0]))<((1<<15)-1) ? (((ref_costs+idx0)[0])+((current+16)[0])) : ((1<<15)-1) ); ((ref_costs+idx0)[1]) = ( (((ref_costs+idx0)[1])+((current+16)[1]))<((1<<15)-1) ? (((ref_costs+idx0)[1])+((current+16)[1])) : ((1<<15)-1) );} while(0); do{ ((ref_costs+idx2)[0]) = ( (((ref_costs+idx2)[0])+((current+32)[0]))<((1<<15)-1) ? (((ref_costs+idx2)[0])+((current+32)[0])) : ((1<<15)-1) ); ((ref_costs+idx2)[1]) = ( (((ref_costs+idx2)[1])+((current+32)[1]))<((1<<15)-1) ? (((ref_costs+idx2)[1])+((current+32)[1])) : ((1<<15)-1) );} while(0); } else { if( mby < height ) { if( mbx < width ) (ref_costs[idx0+0]) = ( ((ref_costs[idx0+0])+(current[16]))<((1<<15)-1) ? ((ref_costs[idx0+0])+(current[16])) : ((1<<15)-1) ); if( mbx+1 < width ) (ref_costs[idx0+1]) = ( ((ref_costs[idx0+1])+(current[17]))<((1<<15)-1) ? ((ref_costs[idx0+1])+(current[17])) : ((1<<15)-1) ); } if( mby+1 < height ) { if( mbx < width ) (ref_costs[idx2+0]) = ( ((ref_costs[idx2+0])+(current[32]))<((1<<15)-1) ? ((ref_costs[idx2+0])+(current[32])) : ((1<<15)-1) ); if( mbx+1 < width ) (ref_costs[idx2+1]) = ( ((ref_costs[idx2+1])+(current[33]))<((1<<15)-1) ? ((ref_costs[idx2+1])+(current[33])) : ((1<<15)-1) ); } } } } } } }} }} } } }
#else
