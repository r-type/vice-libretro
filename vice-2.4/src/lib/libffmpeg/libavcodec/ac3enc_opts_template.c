...
/* AC-3 downmix levels */
    {"center_mixlev", "Center Mix Level", OFFSET(center_mix_level), AV_OPT_TYPE_FLOAT, {0x3fe306fe0a31b715}, 0.0, 1.0, AC3ENC_PARAM},
    {"surround_mixlev", "Surround Mix Level", OFFSET(surround_mix_level), AV_OPT_TYPE_FLOAT, {0x3fe0000000000000}, 0.0, 1.0, AC3ENC_PARAM},
#endif
...
/* extended bitstream information */
    ...
    {"ltrt_cmixlev", "Lt/Rt Center Mix Level", OFFSET(ltrt_center_mix_level), AV_OPT_TYPE_FLOAT, {0xbff0000000000000}, -1.0, 2.0, AC3ENC_PARAM},
    {"ltrt_surmixlev", "Lt/Rt Surround Mix Level", OFFSET(ltrt_surround_mix_level), AV_OPT_TYPE_FLOAT, {0xbff0000000000000}, -1.0, 2.0, AC3ENC_PARAM},
    {"loro_cmixlev", "Lo/Ro Center Mix Level", OFFSET(loro_center_mix_level), AV_OPT_TYPE_FLOAT, {0xbff0000000000000}, -1.0, 2.0, AC3ENC_PARAM},
    {"loro_surmixlev", "Lo/Ro Surround Mix Level", OFFSET(loro_surround_mix_level), AV_OPT_TYPE_FLOAT, {0xbff0000000000000}, -1.0, 2.0, AC3ENC_PARAM},
