...
#ifdef IDE_COMPILE
    {"ich", "set input channel count", OFFSET(in.ch_count), AV_OPT_TYPE_INT, {0}, 0, SWR_CH_MAX, PARAM},
    {"in_channel_count", "set input channel count", OFFSET(in.ch_count), AV_OPT_TYPE_INT, {0}, 0, SWR_CH_MAX, PARAM},
    {"och", "set output channel count", OFFSET(out.ch_count), AV_OPT_TYPE_INT, {0}, 0, SWR_CH_MAX, PARAM},
    {"out_channel_count", "set output channel count", OFFSET(out.ch_count), AV_OPT_TYPE_INT, {0}, 0, SWR_CH_MAX, PARAM},
    {"uch", "set used channel count", OFFSET(used_ch_count), AV_OPT_TYPE_INT, {0}, 0, SWR_CH_MAX, PARAM},
    {"used_channel_count", "set used channel count", OFFSET(used_ch_count), AV_OPT_TYPE_INT, {0}, 0, SWR_CH_MAX, PARAM},
    {"isr", "set input sample rate", OFFSET(in_sample_rate), AV_OPT_TYPE_INT, {0}, 0, INT_MAX, PARAM},
    {"in_sample_rate", "set input sample rate", OFFSET(in_sample_rate), AV_OPT_TYPE_INT, {0}, 0, INT_MAX, PARAM},
    {"osr", "set output sample rate", OFFSET(out_sample_rate), AV_OPT_TYPE_INT, {0}, 0, INT_MAX, PARAM},
    {"out_sample_rate", "set output sample rate", OFFSET(out_sample_rate), AV_OPT_TYPE_INT, {0}, 0, INT_MAX, PARAM},
    {"isf", "set input sample format", OFFSET(in_sample_fmt), AV_OPT_TYPE_SAMPLE_FMT , {AV_SAMPLE_FMT_NONE}, -1, INT_MAX, PARAM},
    {"in_sample_fmt", "set input sample format", OFFSET(in_sample_fmt), AV_OPT_TYPE_SAMPLE_FMT, {AV_SAMPLE_FMT_NONE}, -1, INT_MAX, PARAM},
    {"osf", "set output sample format", OFFSET(out_sample_fmt), AV_OPT_TYPE_SAMPLE_FMT , {AV_SAMPLE_FMT_NONE}, -1, INT_MAX, PARAM},
    {"out_sample_fmt", "set output sample format", OFFSET(out_sample_fmt), AV_OPT_TYPE_SAMPLE_FMT , {AV_SAMPLE_FMT_NONE}, -1, INT_MAX, PARAM},
    {"tsf", "set internal sample format", OFFSET(int_sample_fmt), AV_OPT_TYPE_SAMPLE_FMT, {AV_SAMPLE_FMT_NONE}, -1, INT_MAX, PARAM},
    {"internal_sample_fmt", "set internal sample format", OFFSET(int_sample_fmt), AV_OPT_TYPE_SAMPLE_FMT, {AV_SAMPLE_FMT_NONE}, -1, INT_MAX, PARAM},
    {"icl", "set input channel layout", OFFSET(in_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {0}, 0, INT64_MAX, PARAM, "channel_layout"},
    {"in_channel_layout", "set input channel layout", OFFSET(in_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {0}, 0, INT64_MAX, PARAM, "channel_layout"},
    {"ocl", "set output channel layout", OFFSET(out_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {0}, 0, INT64_MAX, PARAM, "channel_layout"},
    {"out_channel_layout", "set output channel layout", OFFSET(out_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {0}, 0, INT64_MAX, PARAM, "channel_layout"},
    {"clev", "set center mix level", OFFSET(clev), AV_OPT_TYPE_FLOAT, {0x3fe6a09e667f3bcd}, -32, 32, PARAM},
    {"center_mix_level", "set center mix level", OFFSET(clev), AV_OPT_TYPE_FLOAT, {0x3fe6a09e667f3bcd}, -32, 32, PARAM},
    {"slev", "set surround mix level", OFFSET(slev), AV_OPT_TYPE_FLOAT, {0x3fe6a09e667f3bcd}, -32, 32, PARAM},
    {"surround_mix_level", "set surround mix Level", OFFSET(slev), AV_OPT_TYPE_FLOAT, {0x3fe6a09e667f3bcd}, -32, 32, PARAM},
    {"lfe_mix_level", "set LFE mix level", OFFSET(lfe_mix_level), AV_OPT_TYPE_FLOAT, {0}, -32, 32, PARAM},
    {"rmvol", "set rematrix volume", OFFSET(rematrix_volume), AV_OPT_TYPE_FLOAT, {0x3ff0000000000000}, -1000, 1000, PARAM},
    {"rematrix_volume", "set rematrix volume", OFFSET(rematrix_volume), AV_OPT_TYPE_FLOAT, {0x3ff0000000000000}, -1000, 1000, PARAM},
    {"rematrix_maxval", "set rematrix maxval", OFFSET(rematrix_maxval), AV_OPT_TYPE_FLOAT, {0}, 0, 1000, PARAM},
    {"flags", "set flags", OFFSET(flags), AV_OPT_TYPE_FLAGS, {0}, 0, UINT_MAX, PARAM, "flags"},
    {"swr_flags", "set flags", OFFSET(flags), AV_OPT_TYPE_FLAGS, {0}, 0, UINT_MAX, PARAM, "flags"},
    {"res", "force resampling", 0, AV_OPT_TYPE_CONST, {SWR_FLAG_RESAMPLE}, INT_MIN, INT_MAX, PARAM, "flags"},
    {"dither_scale", "set dither scale", OFFSET(dither.scale), AV_OPT_TYPE_FLOAT, {0x3ff0000000000000}, 0, INT_MAX, PARAM},
    {"dither_method", "set dither method", OFFSET(dither.method), AV_OPT_TYPE_INT, {0}, 0, SWR_DITHER_NB-1, PARAM, "dither_method"},
    {"rectangular", "select rectangular dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_RECTANGULAR}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"triangular", "select triangular dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_TRIANGULAR}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"triangular_hp", "select triangular dither with high pass", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_TRIANGULAR_HIGHPASS}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"lipshitz", "select lipshitz noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_LIPSHITZ}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"shibata", "select shibata noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_SHIBATA}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"low_shibata", "select low shibata noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_LOW_SHIBATA}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"high_shibata", "select high shibata noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_HIGH_SHIBATA}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"f_weighted", "select f-weighted noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_F_WEIGHTED}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"modified_e_weighted", "select modified-e-weighted noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_MODIFIED_E_WEIGHTED}, INT_MIN, INT_MAX, PARAM, "dither_method"},
    {"improved_e_weighted", "select improved-e-weighted noise shaping dither", 0, AV_OPT_TYPE_CONST, {SWR_DITHER_NS_IMPROVED_E_WEIGHTED}, INT_MIN, INT_MAX, PARAM, "dither_method"},
