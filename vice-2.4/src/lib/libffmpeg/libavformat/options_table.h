...
{"probesize", "set probing size", OFFSET(probesize2), AV_OPT_TYPE_INT64, {5000000}, 32, INT64_MAX, D},
...
{"fflags", NULL, OFFSET(flags), AV_OPT_TYPE_FLAGS, {AVFMT_FLAG_FLUSH_PACKETS}, INT_MIN, INT_MAX, D|E, "fflags"},
...
{"seek2any", "allow seeking to non-keyframes on demuxer level when supported", OFFSET(seek2any), AV_OPT_TYPE_INT, {0}, 0, 1, D},
{"bitexact", "do not write random/volatile data", 0, AV_OPT_TYPE_CONST, {AVFMT_FLAG_BITEXACT}, 0, 0, E, "fflags" },
{"analyzeduration", "specify how many microseconds are analyzed to probe the input", OFFSET(max_analyze_duration2), AV_OPT_TYPE_INT64, {0}, 0, INT64_MAX, D},
...
{"auto", "enabled when required by target format", 0, AV_OPT_TYPE_CONST, {-1}, INT_MIN, INT_MAX, E, "avoid_negative_ts"},
{"disabled", "do not change timestamps", 0, AV_OPT_TYPE_CONST, {0}, INT_MIN, INT_MAX, E, "avoid_negative_ts"},
{"make_zero", "shift timestamps so they start at 0", 0, AV_OPT_TYPE_CONST, {2}, INT_MIN, INT_MAX, E, "avoid_negative_ts"},
{"make_non_negative", "shift timestamps so they are non negative", 0, AV_OPT_TYPE_CONST, {1}, INT_MIN, INT_MAX, E, "avoid_negative_ts"},
